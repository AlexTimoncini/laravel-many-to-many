...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-4" id="dashboard_actions" class="my-4">
            ...
            <a href="{{ route('admin.technologies.index') }}" class="btn btn-primary d-block mt-2">See Technologies List</a>
            <a href="{{ route('admin.technologies.create') }}" class="btn btn-success d-block mt-2">Add a new Type</a>
        </div>
    </div>
</div>
@endsection